...
var statuses = [`Legal Pilavlı ! Designed By Darkness !'`];
var timers = 2;
const owners = ["1032306377969897593"];
...
client.on('ready', () => {
  client.channels.cache.get('1101203284322160671').join();
})
...
client.login(`MTEwMTIxNDY0NTgxOTI4MTQ3OA.G9S_nS.VmVWZC0vfznin5ij-WSYXz8C9vB7SgVEfiolGs`);